 ...
 * @param value - The string to be validated as a hexadecimal color code
 * @returns - Returns `true` if the string is a valid hexadecimal color code, `false` otherwise
 */
