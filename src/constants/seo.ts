...
export const SITE_DESCRIPTION = "Desarrollador Web Front End con experiencia en JavaScript, CSS, React y Next.js. Descubre mis proyectos y soluciones web de código abierto.";
...
export const SEO_INFO: SEOProps = {
  ...
  languageAlternates: [
    { hrefLang: "es", href: `${ORIGINAL_URL}/es` },
  ],
  openGraph: {
    basic: {
      title: SITE_NAME,
