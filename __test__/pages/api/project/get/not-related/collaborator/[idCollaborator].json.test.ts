...
import {GET} from "@/pages/api/project/get/not-related/collaborator/[idCollaborator].json";
...
describe("GET /project/not-related/collaborator/[idCollaborator] endpoint", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("should return a paginated list of Projects when parameters are valid", async () => {
    ...
    // Simulate a request
    const url = "https://example.com/api/project/get/not-related/collaborator/1?page=1&size=10";
