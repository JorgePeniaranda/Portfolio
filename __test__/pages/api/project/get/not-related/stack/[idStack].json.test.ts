...
import {GET, getStaticPaths} from "@/pages/api/project/get/not-related/stack/[idStack].json";
...
describe("GET /project/not-related/stack/[idStack] endpoint", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("should return a paginated list of Projects when parameters are valid", async () => {
    ...
    // Simulate a request
    const url = "https://example.com/api/project/get/not-related/stack/1?page=1&size=10";
