...
import {PATCH} from "@/pages/api/project/relations/stack/delete";
...
describe("GET /project/relations/stack/delete endpoint", () => {
  ...
  it("should return a project when parameters are valid", async () => {
    ...
    const mockStack = {id: 1, name: "project 1"};

    (databaseClient.project.update as unknown as Mock).mockResolvedValue(mockStack);
    ...
    // Simulate a request
    const url = "https://example.com/api/id/project/relations/stack/delete";
