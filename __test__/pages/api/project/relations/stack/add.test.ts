...
import {PATCH} from "@/pages/api/project/relations/stack/add";
...
describe("GET /project/relations/stack/add endpoint", () => {
  ...
  it("should return a project when parameters are valid", async () => {
    ...
    // Simulate a request
    const url = "https://example.com/api/id/project/relations/stack/add";
