...
import { GET, getStaticPaths } from '@/pages/api/project/not-related/stack/[idStack].json';
...
describe('GET project by not related stack endpoint', () => {
  /**
  ...
  it('should return a list of projects when the stack ID is valid', async () => {
  ...
  it('should return an empty list when no projects are found for the stack ID', async () => {
