...
import { GET, getStaticPaths } from '@/pages/api/collaborator/related/project/[idProject].json';
...
describe('GET collaborator by related project endpoint', () => {
  /**
  ...
  it('should return a paginated list of collaborators when parameters are valid', async () => {
  ...
  it('should return an empty list if no collaborators are found', async () => {
