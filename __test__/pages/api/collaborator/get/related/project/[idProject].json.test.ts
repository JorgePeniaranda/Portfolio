...
import { GET, getStaticPaths } from '@/pages/api/collaborator/get/related/project/[idProject].json';
...
describe('GET /collaborator/related/project/[idProject] endpoint', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should return a paginated list of stacks when parameters are valid', async () => {
    ...
    // Simulate a request
    const url = 'https://example.com/api/get/collaborator/related/project/1?page=1&size=10';
